...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('public/frontend/stylesheets/cropper.css') }}">
</head>
<style type="text/css">
img {
  display: block;
...
<script type="text/javascript" src="{{ asset('public/frontend/javascript/cropper.js') }}"></script>
</body>
</html> 